<script lang="ts">
	...
	import { isLoggedIn, isLoading, signInWithGoogle } from '$lib/stores/auth.svelte';
	...
	$effect(() => {
		if (!authLoading && loggedIn) {
			goto(redirectPath || '/my-recipes');
		}
	});

	function handleGoogleLogin() {
		signInWithGoogle(redirectPath || undefined);
	}
</script>
...
<main class="login-page">
	<div class="login-card">
		<img src="/logo.png" alt="해먹당" class="login-logo" />
